...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    new RawWeapon("knuckles", "An improvement over being unarmed, these metal rings augment their holder's punches nicely.", 'ɱ', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Dueling", "Dueling", "Multi", "Straight", "Yank", "Sweep", "Disarm", "Confound", 4, 2, 4, 3, 2, 0, 3, 6, 0, 0, 6, new String[] {"Metal"}, new String[] {"brawler"}, new String[] {"Ugexiir", "Bididhayi"}),
    ...
    new RawWeapon("katana", "A curved blade that can make deep slices across multiple foes with impressive accuracy.", '†', "Melee", "Repeat", 1, "SLASHING", "SLASHING", "Blade", "Dueling", "Sweep", "Straight", "Sweep", "Blur", "Sever", "Bleed", 5, 5, 1, 1, 5, 0, 3, 0, 0, 2, 6, new String[] {"Metal"}, new String[] {"swordsman", "duelist"}, new String[] {"Otekai", "Ninja"}),
    ...
    new RawWeapon("hammer", "A heavy one-handed tool converted into a weapon of war that is especially strong against armor.", '⊤', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Pound", "Heft", "Sunder", "Confound", 4, 7, 4, 2, 0, 8, 2, 1, 0, 0, 2, new String[] {"Metal|Stone"}, new String[] {"brute"}, new String[] {"Geuhwae"}),
    ...
    new RawWeapon("section staff", "A series of three or more wooden rods connected with chains; originally meant for threshing rice but deadly when swung.", '⋀', "Melee", "Repeat", 2, "BLUNT", "BLUNT", "Bludgeon", "Flexible", "Sweep", "Straight", "Parry", "Sweep", "Confound", "Trip", 4, 4, 0, 2, 6, 4, 2, 0, 0, 2, 4, new String[] {"Wood"}, new String[] {"brawler", "dervish"}, new String[] {"Ninja", "Geuhwae"}),
    ...
    new RawWeapon("caustic magic", "Caustic magic is exceptionally rare, and though it mainly finds industrial uses, some mages can wield it in battle.", '⚡', "Magic", "Repeat", 0, "CAUSTIC", "CAUSTIC", "Energy", "Energy", "Wave", "Straight", "Exorcise", "Reveal", "Afflict", "Blind", 4, 0, 0, 6, 2, 1, 0, 4, 4, 1, 3, new String[] {}, new String[] {"sorcerer", "wizard"}, new String[] {"Geuhwae", "Ugexiir"}),
  ...
  ENTRIES[91], "Ninjutsu style", ENTRIES[92], "Jalgeaux style",
  ...
  ENTRIES[104], "Krort style", ENTRIES[105], "fire magic", ENTRIES[106],
  "earth magic", ENTRIES[107], "water magic", ENTRIES[108], "air magic",
  ENTRIES[109], "crystal magic", ENTRIES[110], "sound magic", ENTRIES[111],
  "ice magic", ENTRIES[112], "lightning magic", ENTRIES[113], "poison magic",
  ENTRIES[114], "acid magic", ENTRIES[115], "caustic magic", ENTRIES[116],
  "disease magic", ENTRIES[117], "death magic", ENTRIES[118], "life magic",
  ENTRIES[119], "shining magic", ENTRIES[120], "shadow magic", ENTRIES[121],
  "temporal magic", ENTRIES[122], "fateful magic", ENTRIES[123], "pure magic",
  ENTRIES[124], "primal magic", ENTRIES[125], "contractual magic", ENTRIES[126],
  "sinister magic", ENTRIES[127], "divine magic", ENTRIES[128], "gravity magic",
  ENTRIES[129], "vacuous magic", ENTRIES[130], "warp magic", ENTRIES[131],
  "radiation magic", ENTRIES[132]);

...
public enum Element { // TODO - make this a full EpiData class with external data source
    ...
    SHADOW(MAGIC, "shadowy", "dim$", new Color(0x404040EE), 0f, 0f), // darkness doesn't really do damage normally, so this is magic
    ...
    PURE(MAGIC, "pure", "purif$$$", new Color(0xCCEEFF88), 0f, 0f), // negatively affects horrible things (undead, demons), does some damage to despoilers of this world

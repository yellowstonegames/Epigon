...
public enum Inclusion implements Material {
    ...
    ALEXANDRITE(SColor.CW_FLUSH_SEAFOAM, SColor.GORYEO_STOREROOM, false, false, false, false, 100),
    ALMANDINE(SColor.DARK_PINK, SColor.DARK_RED, true, false, false, false, 430),
    AMAZONITE(SColor.BRIGHT_GREEN, SColor.PASTEL_GREEN, true, false, false, true, 680),
    AMBER(SColor.AMBER, SColor.GORYEO_STOREROOM, false, false, false, false, 180, 60),
    AMETHYST(SColor.AURORA_THIN_AMETHYST, SColor.AURORA_THICK_AMETHYST, true, true, true, true, 435, 400),
    ...
    AQUAMARINE(SColor.AQUAMARINE, SColor.GORYEO_STOREROOM, false, false, false, false, 1200, 400),
    AZURITE(SColor.CW_AZURE, SColor.GORYEO_STOREROOM, false, false, false, false, 100),
    ...
    CARNELIAN(SColor.RUSSET, SColor.ORANGE_RED, true, true, false, true, 520),
    CATʼS_EYE(SColor.YELLOW, SColor.BROWNER, false, false, true, false, 260),
    CHALCEDONY(SColor.SLATE_GRAY, SColor.GRAY, true, true, false, true, 340),
    CHRYSOBERYL(SColor.CW_PALE_LIME, SColor.GORYEO_STOREROOM, false, false, false, false, 100, 400),
    CHRYSOCOLLA(SColor.CW_BRIGHT_AZURE, SColor.GORYEO_STOREROOM, false, false, false, false, 100),
    CHRYSOPRASE(SColor.CW_LIGHT_GREEN, SColor.GORYEO_STOREROOM, false, false, false, false, 600, 300),
    ...
    GOSHENITE(SColor.ALICE_BLUE, SColor.GORYEO_STOREROOM, false, false, false, false, 90, 400),
    HACKMANITE(SColor.LIGHT_PINK, SColor.DARK_PINK, false, false, false, true, 600),
    HELIODOR(SColor.GOLDEN_YELLOW, SColor.GORYEO_STOREROOM, false, false, false, false, 900, 400),
    IOLITE(SColor.AURORA_IOLITE, SColor.PIGMENT_BLUE, true, false, true, false, 180),
    ...
    JET(SColor.AURORA_WATERCOLOR_BLACK, SColor.CW_ALMOST_BLACK, false, false, false, false, 100),
    KUNZITE(SColor.GRAY_ASPARAGUS, SColor.GORYEO_STOREROOM, false, false, false, false, 100),
    ...
    LAPIS_LAZULI(SColor.LAPIS_LAZULI, SColor.GORYEO_STOREROOM, false, false, false, false, 100),
    ...
    MORGANITE(SColor.AURORA_SILVER_PINK, SColor.PASTEL_PINK, false, false, false, false, 1500, 400),
    ...
    PERIDOT(SColor.CW_FLUSH_CHARTREUSE, SColor.GORYEO_STOREROOM, false, false, false, false, 700),
    PRASE(SColor.AURORA_PRASE, SColor.TEAL, false, false, false, false, 500, 300),
    ...
    STAUROLITE(SColor.BRUSHWOOD_DYED, SColor.AURORA_CLOUD, false, false, false, false, 80, 2300),
    ...
    TIGERʼS_EYE(SColor.BROWNER, SColor.BROWN, true, true, false, false, 830),
    TOPAZ(SColor.CHERRY_BLOSSOM, SColor.CARNATION_PINK, false, false, true, false, 6290),
    TOURMALINE(SColor.CW_RICH_SEAFOAM, SColor.DEEP_CERISE, false, false, false, false, 100),
    ...
    TURQUOISE(SColor.TURQUOISE, SColor.GORYEO_STOREROOM, false, false, false, false, 100),

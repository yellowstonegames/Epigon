...
public class ImplementWeapon {
  public static final ImplementWeapon[] ENTRIES = new ImplementWeapon[] {
    ...
    new ImplementWeapon("vile grimoire", "An Occult wielder's best (or only) friend, this black book, bound in some kind of skin, can obliterate nearby enemies.", '⍌', "Implement", "Occult", 2, "Storm", "Death", "Wave", "Straight", "Linger", "Wither", 2, 8, 4, 0, 0, 0, 0, 4, 2, new String[] {"Paper", "Leather"}),
    ...
    new ImplementWeapon("scholarly tome", "A thick Arcane encyclopedia, laden with enchantments that can drive off enemies who come too close.", '⌺', "Implement", "Arcane", 2, "Earth", "Fire", "Wave", "Straight", "Confound", "Linger", 5, 3, 4, 0, 2, 0, 1, 5, 0, new String[] {"Paper", "Leather"}),
    new ImplementWeapon("magus scepter", "A strong effort by Arcane wielders to one-up firearms, this staff with various gems and sigils on it can fire energy blasts.", '∤', "Implement", "Arcane", 1, "Fire", "Storm", "Beam", "Straight", "Awe", "Energize", 4, 7, 1, 0, 1, 0, 0, 5, 2, new String[] {"Inclusion", "Wood"}),
  };

...
public class RangedWeapon {
  public static final RangedWeapon[] ENTRIES = new RangedWeapon[] {
    new RangedWeapon("shortbow", "A smaller bow that isn't as unwieldy in close-quarters combat as a Longbow, and isn't as conspicuous when carried.", '(', "Ranged", "Projectile", 2, "Piercing", "Piercing", "Forceful", "Arc", "Pin", "Arrows", 4, 4, 0, 1, 0, 1, 1, 4, 5, new String[] {"Wood"}),
    new RangedWeapon("longbow", "A very large bow, usually taller than its wielder, that boasts tremendous range and hefty power.", '(', "Ranged", "Projectile", 2, "Piercing", "Piercing", "Forceful", "Arc", "Heave", "Arrows", 3, 5, 1, 0, 0, 1, 0, 6, 4, new String[] {"Wood"}),
    ...
    new RangedWeapon("sling", "An early stone-hurling weapon made from cord and hide, it has considerably better range than throwing a rock by hand.", '⍩', "Ranged", "Projectile", 1, "Blunt", "Blunt", "Forceful", "Arc", "Yank", "Pellets", 3, 2, 3, 0, 0, 2, 4, 3, 3, new String[] {"Leather"}),
    new RangedWeapon("staff sling", "A curved staff with cords to hold a projectile at one end, this weapon improves a Sling's range even further.", 'Ḯ', "Ranged", "Projectile", 2, "Blunt", "Blunt", "Forceful", "Arc", "Pound", "Pellets", 2, 4, 2, 0, 2, 1, 1, 5, 3, new String[] {"Leather"}),
    ...
    new RangedWeapon("bolas", "A pair of weights linked with a cord that can be thrown with a spinning motion to entangle a target's legs or arms.", 'ʊ', "Ranged", "Thrown", 1, "Blunt", "Blunt", "Flexible", "Arc", "Yank", "Pin", 3, 2, 0, 3, 0, 4, 3, 2, 3, new String[] {"Leather", "Stone"}),

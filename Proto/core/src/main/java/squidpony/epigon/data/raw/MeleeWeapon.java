...
public class MeleeWeapon {
  public static final MeleeWeapon[] ENTRIES = new MeleeWeapon[] {
    ...
    new MeleeWeapon("carving knife", "This sharpened chef's implement is just as good at slicing up a steak as it is slashing living flesh.", '▶', "Melee", "Repeat", 1, "Piercing", "Slashing", "Dueling", "Dueling", "Parry", "Hurl", 4, 1, 3, 5, 0, 2, 5, 0, 0, new String[] {"Metal|Stone"}),
    new MeleeWeapon("handaxe", "Some call them tomahawks, others hunga munga; this is a throwing axe by any name.", '⚑', "Melee", "Repeat", 1, "Slashing", "Slashing", "Axe", "Axe", "Chop", "Hurl", 3, 5, 7, 3, 1, 0, 1, 0, 0, new String[] {"Metal|Stone", "Wood"}),
    new MeleeWeapon("hatchet", "A medium-sized axe balanced for carving wood rather than throwing, it can carve flesh just as well.", '⚑', "Melee", "Repeat", 1, "Slashing", "Slashing", "Axe", "Axe", "Chop", "Heft", 1, 7, 8, 2, 2, 0, 0, 0, 0, new String[] {"Metal|Stone", "Wood"}),
    ...
    new MeleeWeapon("leaf spear", "A heavier mid-length spear with a broad leaf-shaped blade at the end; it can be used for slicing and stabbing alike.", '⍋', "Melee", "Repeat", 2, "Piercing", "Slashing", "Polearm", "Polearm", "Thrust", "Sweep", 2, 6, 4, 1, 3, 0, 0, 1, 1, new String[] {"Metal", "Wood"}),
    ...
    new MeleeWeapon("hand flail", "A nasty spiked ball whipped around on a heavy chain; it's simply brutal against armored foes.", '!', "Melee", "Repeat", 1, "Blunt", "Blunt", "Bludgeon", "Flexible", "Sweep", "Yank", 3, 7, 0, 0, 6, 2, 0, 0, 1, new String[] {"Metal|Stone", "Wood"}),
    new MeleeWeapon("meteor flail", "A small, heavy weight on the end of a long vine or rope; making one is easy, but fighting with one is very hard.", '!', "Melee", "Repeat", 2, "Blunt", "Blunt", "Bludgeon", "Flexible", "Heft", "Yank", 3, 4, 0, 3, 0, 4, 0, 3, 0, new String[] {"Metal|Stone", "Hide"}),
    new MeleeWeapon("whip", "A leather bullwhip that's flexible enough to knock a weapon from the hands of nearby opponents.", '∫', "Melee", "Repeat", 1, "Blunt", "Slashing", "Flexible", "Flexible", "Lunge", "Yank", 5, 0, 4, 3, 0, 4, 0, 2, 0, new String[] {"Hide"}),
    ...
    new MeleeWeapon("light shield", "A shield that's meant for actively parrying and blocking enemy attacks, mixing in quick jabs with the edge of the shield.", '⍟', "Melee", "Repeat", 1, "Blunt", "Blunt", "Bludgeon", "Dueling", "Parry", "Blur", 3, 2, 0, 7, 7, 1, 0, 0, 0, new String[] {"Hide|Metal|Wood"}),
    new MeleeWeapon("heavy shield", "A large shield that's effective at defending even while barely moving, but it's hard to precisely wield one.", '⍟', "Melee", "Repeat", 1, "Blunt", "Blunt", "Bludgeon", "Bludgeon", "Parry", "Heft", 1, 5, 0, 5, 9, 0, 0, 0, 0, new String[] {"Metal|Wood"}),
    new MeleeWeapon("macahuitl", "A heavy wooden shaft that's been augmented with razor-sharp stone blades along its edge; incredibly dangerous.", '≢', "Melee", "Repeat", 2, "Slashing", "Blunt", "Blade", "Bludgeon", "Heft", "Sweep", 1, 9, 8, 0, 0, 0, 0, 0, 1, new String[] {"Wood", "Stone"}),
  };

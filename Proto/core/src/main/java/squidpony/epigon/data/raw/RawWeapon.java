...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("pistol", "This hand-held firearm is very imprecise, but that doesn't always hinder it because its bullet keeps bouncing after missing.", 'ᵣ', "Ranged", "Projectile", 1, "Piercing", "Piercing", "Precise", "Precise", "Multi", "Straight", "Ricochet", "Powder", "Slay", "Silence", 3, 8, 7, 1, 0, 0, 0, 3, 4, 0, 0, new String[] {"Metal"}),
    new RawWeapon("musket", "A heavy two-handed firearm with better accuracy than a Pistol and longer range, but more lengthy reload times.", 'ɼ', "Ranged", "Projectile", 2, "Piercing", "Piercing", "Precise", "Precise", "Multi", "Straight", "Ricochet", "Powder", "Slay", "Silence", 2, 9, 8, 1, 0, 0, 0, 0, 5, 0, 0, new String[] {"Metal"}),
    ...
    new RawWeapon("channeling orb", "A small round crystal that a Mystic wielder can use to disrupt the energy flow of an enemy, or supplant a friend's.", '●', "Implement", "Repeat", 1, "Fate", "Light", "Mystic", "Mystic", "Through", "Straight", "Pound", "Shine", "Confound", "Energize", 5, 1, 0, 6, 1, 0, 2, 1, 5, 2, 0, new String[] {"Inclusion"}),
    new RawWeapon("mystic deck", "A deck of many fortune-telling cards, each decorated with cryptic imagery; an interpretation can be used as a Mystic curse.", '⍰', "Implement", "Repeat", 2, "Shadow", "Fate", "Mystic", "Mystic", "Multi", "Straight", "Weave", "Hex", "Curse", "Favor", 2, 1, 5, 1, 0, 0, 6, 2, 4, 1, 3, new String[] {"Paper"}),
    ...
    new RawWeapon("holy symbol", "When carried by a Blessed wielder, this sacred icon can issue shining judgment even when simply worn or carried.", 'ᵸ', "Implement", "Repeat", 0, "Divine", "Light", "Blessed", "Blessed", "Multi", "Straight", "Shine", "Exorcise", "Judge", "Regenerate", 4, 4, 0, 4, 0, 0, 5, 0, 3, 2, 3, new String[] {"Metal|Wood"}),
    new RawWeapon("sacred book", "A ritually-purified holy text that serves to channel Blessed faith into waves of divine wrath against transgressors.", '⍐', "Implement", "Repeat", 2, "Pure", "Divine", "Blessed", "Blessed", "Wave", "Straight", "Seal", "Exorcise", "Awe", "Judge", 3, 5, 0, 3, 0, 0, 5, 0, 3, 3, 1, new String[] {"Paper", "Metal"}),
    ...
    new RawWeapon("scholarly tome", "A thick Arcane encyclopedia, laden with enchantments that can drive off enemies who come too close.", '⌺', "Implement", "Repeat", 2, "Earth", "Fire", "Arcane", "Arcane", "Wave", "Straight", "Seal", "Reveal", "Confound", "Linger", 5, 3, 0, 4, 0, 2, 0, 0, 5, 3, 0, new String[] {"Paper", "Hide"}),
    new RawWeapon("magus scepter", "A strong effort by Arcane wielders to one-up firearms, this staff with various gems and sigils on it can fire energy blasts.", '∤', "Implement", "Repeat", 1, "Fire", "Storm", "Arcane", "Bludgeon", "Beam", "Straight", "Pound", "Reveal", "Slay", "Energize", 4, 7, 0, 2, 0, 1, 0, 0, 5, 2, 2, new String[] {"Wood", "Inclusion"}),
  };
  ...
  "macahuitl", ENTRIES[34], "shortbow", ENTRIES[35], "longbow", ENTRIES[36],
  "light crosssbow", ENTRIES[37], "heavy crossbow", ENTRIES[38], "pistol",
  ENTRIES[39], "musket", ENTRIES[40], "sling", ENTRIES[41], "staff sling",
  ENTRIES[42], "chakram", ENTRIES[43], "boomerang", ENTRIES[44], "javelin",
  ENTRIES[45], "atlatl", ENTRIES[46], "shuriken", ENTRIES[47], "blowgun",
  ENTRIES[48], "bolas", ENTRIES[49], "net", ENTRIES[50], "grenade", ENTRIES[51],
  "handcannon", ENTRIES[52], "throwing dagger", ENTRIES[53], "channeling orb",
  ENTRIES[54], "mystic deck", ENTRIES[55], "fossil fang", ENTRIES[56],
  "green wreath", ENTRIES[57], "holy symbol", ENTRIES[58], "sacred book",
  ENTRIES[59], "vile grimoire", ENTRIES[60], "black lantern", ENTRIES[61],
  "scholarly tome", ENTRIES[62], "magus scepter", ENTRIES[63]);

...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("scholarly tome", "A thick Arcane encyclopedia, laden with enchantments that can drive off enemies who come too close.", '⌺', "Implement", "Repeat", 2, "Fire", "Earth", "Arcane", "Arcane", "Wave", "Straight", "Seal", "Reveal", "Confound", "Linger", 5, 3, 0, 4, 0, 2, 0, 0, 5, 3, 0, new String[] {"Paper", "Hide"}),

...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("soul pyramid", "A mysterious stone that seems fated to belong to a Mystic wielder; to such a bearer it grants esoteric powers.", '⍙', "Implement", "Repeat", 1, "DEATH", "PURE", "Mystic", "Mystic", "Burst", "Arc", "Exorcise", "Condemn", "Awe", "Curse", 1, 7, 0, 4, 0, 1, 4, 1, 3, 3, 0, new String[] {"Stone"}, new String[] {"Foresight"}, new String[] {"Hidzaajji"}),
    ...
    new RawWeapon("holy symbol", "When carried by a Blessed wielder, this sacred icon can issue shining judgment even when simply worn or carried.", 'ᵸ', "Implement", "Repeat", 0, "DIVINE", "SHINING", "Blessed", "Blessed", "Multi", "Straight", "Shine", "Exorcise", "Regenerate", "Awe", 4, 4, 0, 4, 0, 0, 5, 0, 3, 2, 3, new String[] {"Metal|Wood"}, new String[] {"Elegance"}, new String[] {"Hyrden", "Cheuritae"}),
    ...
    new RawWeapon("Water magic", "Water magic utilizes various unpleasant compounds swirled in with otherwise-harmless fluid to cause all sorts of trouble.", '⚡', "Magic", "Repeat", 0, "WATER", "WATER", "Energy", "Energy", "Wave", "Straight", "Blur", "Exorcise", "Trip", "Afflict", 4, 1, 0, 5, 3, 0, 2, 4, 3, 2, 1, new String[] {}, new String[] {"Sorcery", "Whirling Death"}, new String[] {"Ikkutiq", "Cheuritae"}),

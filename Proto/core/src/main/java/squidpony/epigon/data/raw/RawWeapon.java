...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("musket", "A heavy two-handed firearm with better accuracy than a Pistol and longer range, but more lengthy reload times.", 'ɼ', "Ranged", "Projectile", 2, "PIERCING", "PIERCING", "Precise", "Precise", "Multi", "Straight", "Ricochet", "Powder", "Slay", "Confound", 2, 9, 8, 1, 0, 0, 0, 0, 5, 0, 0, new String[] {"Metal"}, new String[] {"Marksmanship", "Elegance"}, new String[] {"Zedmedov", "Jalgeaux"}),
    ...
    new RawWeapon("pan pipes", "A traditional simple musical instrument that is said to make the favorite sound for spirits of the land.", 'ˠ', "Implement", "Repeat", 1, "SOUND", "PRIMAL", "Primal", "Primal", "Wave", "Straight", "Pound", "Exorcise", "Silence", "Favor", 3, 1, 0, 5, 4, 0, 6, 0, 3, 2, 1, new String[] {"Wood"}, new String[] {"Sorcery", "Naturalism"}, new String[] {"Elethian", "Hyrden"}),
    new RawWeapon("holy symbol", "When carried by a Blessed wielder, this sacred icon can issue shining judgment even when simply worn or carried.", 'ᵸ', "Implement", "Repeat", 0, "DIVINE", "SHINING", "Blessed", "Blessed", "Multi", "Straight", "Shine", "Exorcise", "Regenerate", "Blind", 4, 4, 0, 4, 0, 0, 5, 0, 3, 2, 3, new String[] {"Metal|Wood"}, new String[] {"Sorcery", "Elegance"}, new String[] {"Hyrden", "Cheuritae"}),
    ...
    new RawWeapon("vile grimoire", "An Occult wielder's best (or only) friend, this black book, bound in some kind of skin, can obliterate nearby enemies.", '⍌', "Implement", "Repeat", 2, "SINISTER", "ACID", "Occult", "Occult", "Wave", "Straight", "Condemn", "Hex", "Afflict", "Sizzle", 2, 8, 0, 5, 0, 0, 0, 0, 4, 3, 1, new String[] {"Paper", "Hide"}, new String[] {"Sorcery", "Assassination"}, new String[] {"Krort", "Hueztotli"}),
    ...
    new RawWeapon("magus scepter", "A strong effort by Arcane wielders to one-up firearms, this staff with various gems and sigils on it can fire energy blasts.", '∤', "Implement", "Repeat", 1, "FIRE", "RADIATION", "Arcane", "Bludgeon", "Beam", "Straight", "Pound", "Reveal", "Sizzle", "Slay", 4, 7, 0, 2, 0, 1, 0, 0, 5, 2, 2, new String[] {"Wood", "Inclusion"}, new String[] {"Sorcery", "Marksmanship"}, new String[] {"Hueztotli", "Ikkutiq"}),
  ...
  ENTRIES[57], "dancing fan", ENTRIES[58], "fossil fang", ENTRIES[59],
  "green wreath", ENTRIES[60], "primeval shield", ENTRIES[61], "pan pipes",
  ENTRIES[62], "holy symbol", ENTRIES[63], "sacred book", ENTRIES[64],
  "prayer beads", ENTRIES[65], "cherished icon", ENTRIES[66], "vile grimoire",
  ENTRIES[67], "black lantern", ENTRIES[68], "eldritch prism", ENTRIES[69],
  "fractal knot", ENTRIES[70], "scholarly tome", ENTRIES[71], "magus scepter",
  ENTRIES[72], "wizardly wand", ENTRIES[73], "stargazer lens", ENTRIES[74],
  "Zedmedov style", ENTRIES[75], "Cheuritae style", ENTRIES[76], "Hyrden style",
  ENTRIES[77], "Mbegonda style", ENTRIES[78], "Ninjutsu style", ENTRIES[79],
  "Jalgeaux style", ENTRIES[80], "Ikkutiq style", ENTRIES[81], "Ugexiir style",
  ENTRIES[82], "Hidzaajji style", ENTRIES[83], "Laathrik style",
  ENTRIES[84], "Hueztotli style", ENTRIES[85], "Keungeuh style",
  ENTRIES[86], "Khainghal style", ENTRIES[87], "Bididhayi style",
  ENTRIES[88], "Mobyuld style", ENTRIES[89], "Chobesh style", ENTRIES[90],
  "Elethian style", ENTRIES[91], "Krort style", ENTRIES[92], "Fire magic",
  ENTRIES[93], "Earth magic", ENTRIES[94], "Water magic", ENTRIES[95],
  "Air magic", ENTRIES[96], "Crystal magic", ENTRIES[97], "Sound magic",
  ENTRIES[98], "Ice magic", ENTRIES[99], "Lightning magic", ENTRIES[100],
  "Poison magic", ENTRIES[101], "Acid magic", ENTRIES[102], "Caustic magic",
  ENTRIES[103], "Disease magic", ENTRIES[104], "Death magic", ENTRIES[105],
  "Life magic", ENTRIES[106], "Shining magic", ENTRIES[107], "Shadow magic",
  ENTRIES[108], "Temporal magic", ENTRIES[109], "Fateful magic", ENTRIES[110],
  "Pure magic", ENTRIES[111], "Primal magic", ENTRIES[112], "Contractual magic",
  ENTRIES[113], "Sinister magic", ENTRIES[114], "Divine magic",
  ENTRIES[115], "Gravity magic", ENTRIES[116], "Vacuous magic", ENTRIES[117],
  "Warp magic", ENTRIES[118], "Radiation magic", ENTRIES[119]);

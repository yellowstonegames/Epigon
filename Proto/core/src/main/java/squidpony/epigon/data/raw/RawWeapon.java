...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("cape", "Among the least effective ways to kill someone, but great for confusing or disarming foes while keeping your hands free.", '⍝', "Melee", "Repeat", 0, "BLUNT", "BLUNT", "Flexible", "Flexible", "Sweep", "Straight", "Blur", "Yank", "Confound", "Disarm", 2, 1, 0, 6, 6, 0, 2, 3, 0, 2, 6, new String[] {"Cloth"}, new String[] {"Elegance", "Whirling Death"}, new String[] {"Jalgeaux"}),
    ...
    new RawWeapon("musket", "A heavy two-handed firearm with better accuracy than a Pistol and longer range, but more lengthy reload times.", 'ɼ', "Ranged", "Projectile", 2, "PIERCING", "PIERCING", "Precise", "Precise", "Multi", "Straight", "Ricochet", "Powder", "Slay", "Confound", 2, 9, 8, 1, 0, 0, 0, 0, 5, 0, 0, new String[] {"Metal"}, new String[] {"Marksmanship"}, new String[] {"Zedmedov", "Jalgeaux"}),
    ...
    new RawWeapon("staff sling", "A curved staff with cords to hold a projectile at one end, this weapon improves a Sling's range even further.", 'Ḯ', "Ranged", "Projectile", 2, "BLUNT", "BLUNT", "Forceful", "Forceful", "Multi", "Arc", "Pound", "Pellets", "Confound", "Slay", 2, 4, 2, 5, 0, 2, 1, 1, 5, 0, 3, new String[] {"Hide"}, new String[] {"Hurling", "Foresight"}, new String[] {"Ikkutiq"}),
    ...
    new RawWeapon("Fire magic", "Fire magic is anything but subtle, emphasizing heavy damage across wide areas.", '⚡', "Magic", "Repeat", 0, "FIRE", "FIRE", "Energy", "Energy", "Beam", "Straight", "Sweep", "Exorcise", "Slay", "Sizzle", 1, 8, 0, 1, 2, 0, 0, 4, 3, 3, 2, new String[] {}, new String[] {"Sorcery", "Brutality"}, new String[] {"Mobyuld", "Chobesh"}),
    ...
    new RawWeapon("Ice magic", "Ice magic delivers prolonged suffering by freezing foes in place and chilling them to the bone.", '⚡', "Magic", "Repeat", 0, "ICE", "ICE", "Energy", "Energy", "Wave", "Straight", "Pin", "Seal", "Disable", "Sizzle", 5, 2, 0, 6, 1, 2, 0, 4, 3, 1, 2, new String[] {}, new String[] {"Sorcery", "Assassination"}, new String[] {"Zedmedov", "Ikkutiq"}),
    ...
    new RawWeapon("Shining magic", "Shining magic can wreak havoc on wide areas with laser-like beams of searing light.", '⚡', "Magic", "Repeat", 0, "SHINING", "SHINING", "Energy", "Energy", "Beam", "Straight", "Exorcise", "Reveal", "Blind", "Sizzle", 6, 1, 2, 2, 0, 0, 1, 0, 6, 2, 2, new String[] {}, new String[] {"Sorcery", "Marksmanship"}, new String[] {"Hyrden", "Hidzaajji"}),
    ...
    new RawWeapon("Gravity magic", "Gravity magic is tricky and can be an excellent way to immobilize an enemy.", '⚡', "Magic", "Repeat", 0, "GRAVITY", "GRAVITY", "Energy", "Energy", "Burst", "Straight", "Pin", "Yank", "Trip", "Disarm", 3, 1, 0, 5, 3, 0, 2, 4, 3, 2, 2, new String[] {}, new String[] {"Sorcery", "Whirling Death"}, new String[] {"Jalgeaux", "Hidzaajji"}),
  ...
  "Air magic", ENTRIES[91], "Crystal magic", ENTRIES[92], "Sound magic",
  ENTRIES[93], "Ice magic", ENTRIES[94], "Lightning magic", ENTRIES[95],
  "Poison magic", ENTRIES[96], "Acid magic", ENTRIES[97], "Caustic magic",
  ENTRIES[98], "Disease magic", ENTRIES[99], "Death magic", ENTRIES[100],
  "Life magic", ENTRIES[101], "Shining magic", ENTRIES[102], "Shadow magic",
  ENTRIES[103], "Temporal magic", ENTRIES[104], "Fateful magic", ENTRIES[105],
  "Pure magic", ENTRIES[106], "Primal magic", ENTRIES[107], "Contractual magic",
  ENTRIES[108], "Sinister magic", ENTRIES[109], "Divine magic",
  ENTRIES[110], "Gravity magic", ENTRIES[111], "Vacuous magic", ENTRIES[112],
  "Warp magic", ENTRIES[113], "Radiation magic", ENTRIES[114]);

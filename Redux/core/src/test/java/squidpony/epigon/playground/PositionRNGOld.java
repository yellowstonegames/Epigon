 ...
 */
public final class PositionRNGOld
{
    public long stream;
...
//    }
    ...
    public PositionRNGOld()
    {
        this(1L);
    }

    public PositionRNGOld(long seed)
    {
        this(seed, 0L, 0L);
    }
    public PositionRNGOld(long seed, long x, long y)
    {
        stream = hash2(x, y) | 1L;
        state = seed;
    }
    public PositionRNGOld(long state, long stream)
    {
    ...
    public PositionRNGOld copy() {
        return new PositionRNGOld(state, stream);
    }

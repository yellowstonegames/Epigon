...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("bladed boots", "A dastardly weapon typically used by assassins, this formal footwear conceals a wicked blade that extends on contact.", '˩', "Melee", "Repeat", 5, "PIERCING", "PIERCING", "Dueling", "Dueling", "Multi", "Straight", "Blur", "Pound", "Bleed", "Trip", 3, 2, 6, 5, 3, 0, 0, 6, 0, 0, 5, new String[] {"Hide"}, new String[] {"Assassination"}, new String[] {"Jalgeaux", "Hidzaajji"}),

...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    ...
    new RawWeapon("mace", "Not just any stick, this one's made of solid metal, and can pulverize armor with a good wallop.", '╿', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Parry", "Pound", "Disarm", "Confound", 4, 5, 3, 1, 0, 9, 4, 0, 0, 0, 4, new String[] {"Metal|Stone"}, new String[] {"brute", "priest"}, new String[] {"Hyrden", "Cheuritae"}),
    ...
    new RawWeapon("whip", "A leather bullwhip that's flexible enough to knock a weapon from the hands of nearby opponents.", '∫', "Melee", "Repeat", 1, "BLUNT", "SLASHING", "Flexible", "Flexible", "Multi", "Arc", "Lunge", "Yank", "Disarm", "Trip", 4, 1, 4, 6, 3, 0, 4, 0, 2, 0, 4, new String[] {"Hide"}, new String[] {"dervish", "shaman"}, new String[] {"Hidzaajji", "Mobyuld"}),
    ...
    new RawWeapon("mystic deck", "A deck of many fortune-telling cards, each decorated with cryptic imagery; an interpretation can be used as a Mystic curse.", '⍰', "Implement", "Repeat", 2, "FATEFUL", "TEMPORAL", "Mystic", "Mystic", "Multi", "Straight", "Weave", "Hex", "Curse", "Favor", 2, 1, 5, 1, 0, 0, 6, 2, 4, 1, 3, new String[] {"Paper"}, new String[] {"seer", "jester"}, new String[] {"Jalgeaux", "Keungeuh"}),
    new RawWeapon("soul pyramid", "A mysterious stone that seems fated to belong to a Mystic wielder; to such a bearer it grants esoteric powers.", '⍙', "Implement", "Repeat", 1, "DEATH", "PURE", "Mystic", "Mystic", "Burst", "Arc", "Exorcise", "Condemn", "Silence", "Curse", 1, 7, 0, 4, 0, 1, 4, 1, 3, 3, 0, new String[] {"Stone"}, new String[] {"seer", "guardian"}, new String[] {"Hidzaajji"}),
    new RawWeapon("dancing fan", "A paper fan that seems to move at the slightest touch; it can exert power over the wind and over fate.", '⍢', "Implement", "Repeat", 1, "AIR", "FATEFUL", "Mystic", "Mystic", "Wave", "Straight", "Seal", "Blur", "Trip", "Curse", 2, 1, 0, 5, 4, 0, 4, 0, 3, 3, 2, new String[] {"Paper"}, new String[] {"seer", "duelist"}, new String[] {"Otekai", "Hidzaajji"}),

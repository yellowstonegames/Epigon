...
public class RawWeapon implements Serializable {
  ...
  public static final RawWeapon[] ENTRIES = new RawWeapon[] {
    new RawWeapon("knuckles", "An improvement over being unarmed, these metal rings augment their holder's punches nicely.", 'ɱ', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Dueling", "Dueling", "Multi", "Straight", "Yank", "Sweep", "Disarm", "Confound", 4, 2, 4, 3, 2, 0, 3, 6, 0, 0, 6, new String[] {"Metal"}, new String[] {"Brawler"}, new String[] {"Ugexiir"}),
    ...
    new RawWeapon("katana", "A curved blade attributed mystical power that can make effortless quick slices with impressive accuracy.", '†', "Melee", "Repeat", 1, "SLASHING", "SLASHING", "Blade", "Dueling", "Sweep", "Straight", "Sweep", "Blur", "Sever", "Bleed", 5, 5, 1, 1, 5, 0, 3, 0, 0, 2, 6, new String[] {"Metal"}, new String[] {"Swordsman", "Duelist"}, new String[] {"Otekai", "Ninja"}),
    ...
    new RawWeapon("carving knife", "This sharpened chef's implement is just as good at slicing up a steak as it is slashing living flesh.", '▶', "Melee", "Repeat", 1, "PIERCING", "SLASHING", "Dueling", "Dueling", "Multi", "Straight", "Parry", "Hurl", "Impale", "Silence", 6, 2, 3, 3, 5, 0, 0, 5, 0, 0, 6, new String[] {"Metal|Stone"}, new String[] {"Swordsman", "Assassin"}, new String[] {"Mobyuld", "Laathrik"}),
    ...
    new RawWeapon("hatchet", "A medium-sized axe balanced for carving wood rather than throwing, it can carve flesh just as well.", '⚑', "Melee", "Repeat", 1, "SLASHING", "SLASHING", "Axe", "Axe", "Sweep", "Straight", "Chop", "Heft", "Sever", "Sunder", 2, 7, 8, 1, 2, 2, 5, 0, 0, 0, 3, new String[] {"Metal|Stone", "Wood"}, new String[] {"Brute", "Hunter"}, new String[] {"Ugexiir", "Mbegonda"}),
    ...
    new RawWeapon("cape", "Among the least effective ways to kill someone, but great for confusing or disarming foes while keeping your hands free.", '⍝', "Melee", "Repeat", 4, "BLUNT", "BLUNT", "Flexible", "Flexible", "Sweep", "Straight", "Blur", "Yank", "Confound", "Disarm", 2, 1, 0, 6, 6, 0, 2, 3, 0, 2, 6, new String[] {"Cloth"}, new String[] {"Duelist", "Dervish"}, new String[] {"Jalgeaux"}),
    new RawWeapon("hammer", "A heavy one-handed tool converted into a weapon of war that is especially strong against armor.", '⊤', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Pound", "Heft", "Sunder", "Confound", 4, 7, 4, 2, 0, 8, 2, 1, 0, 0, 2, new String[] {"Metal|Stone"}, new String[] {"Brute"}, new String[] {"Keungeuh"}),
    new RawWeapon("maul", "A brutal two-handed sledgehammer that seems impractical against all but the slowest foes -- or monsters.", '⊤', "Melee", "Repeat", 2, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Pound", "Heft", "Sunder", "Trip", 2, 9, 5, 2, 0, 9, 2, 0, 0, 0, 1, new String[] {"Metal|Stone"}, new String[] {"Brute"}, new String[] {"Krort", "Keungeuh"}),
    new RawWeapon("club", "A plain-old heavy stick that can be swung with surprising speed, and can be passed off as a normal twig.", '╿', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Pound", "Hurl", "Trip", "Disarm", 3, 3, 1, 2, 2, 4, 5, 5, 0, 0, 5, new String[] {"Wood"}, new String[] {"Brute", "Hunter"}, new String[] {"Mbegonda", "Ninja"}),
    new RawWeapon("mace", "Not just any stick, this one's made of solid metal, and can pulverize armor with a good wallop.", '╿', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Bludgeon", "Multi", "Straight", "Parry", "Pound", "Disarm", "Confound", 4, 5, 3, 1, 0, 9, 4, 0, 0, 0, 4, new String[] {"Metal|Stone"}, new String[] {"Brute"}, new String[] {"Hyrden", "Cheuritae"}),
    ...
    new RawWeapon("nunchaku", "A martial-arts weapon consisting of two club-like bars connected with a short chain; excellent for defensive use.", '⋀', "Melee", "Repeat", 1, "BLUNT", "BLUNT", "Bludgeon", "Flexible", "Sweep", "Straight", "Parry", "Blur", "Confound", "Disarm", 5, 2, 0, 2, 6, 2, 2, 5, 0, 1, 4, new String[] {"Wood"}, new String[] {"Brawler", "Dervish"}, new String[] {"Ninja"}),
    new RawWeapon("section staff", "A series of three or more wooden rods connected with chains; originally meant for threshing rice but deadly when swung.", '⋀', "Melee", "Repeat", 2, "BLUNT", "BLUNT", "Bludgeon", "Flexible", "Sweep", "Straight", "Parry", "Sweep", "Confound", "Trip", 4, 4, 0, 2, 6, 4, 2, 0, 0, 2, 4, new String[] {"Wood"}, new String[] {"Brawler", "Dervish"}, new String[] {"Ninja", "Keungeuh"}),
    ...
    new RawWeapon("meteor flail", "A small, heavy weight on the end of a long vine or rope; making one is easy, but fighting with one is very hard.", '!', "Melee", "Repeat", 2, "BLUNT", "BLUNT", "Bludgeon", "Flexible", "Multi", "Arc", "Heft", "Yank", "Disarm", "Trip", 3, 6, 3, 5, 2, 0, 3, 0, 3, 0, 2, new String[] {"Metal|Stone", "Hide"}, new String[] {"Brawler", "Dervish"}, new String[] {"Hueztotli", "Ninja"}),
    new RawWeapon("whip", "A leather bullwhip that's flexible enough to knock a weapon from the hands of nearby opponents.", '∫', "Melee", "Repeat", 1, "BLUNT", "SLASHING", "Flexible", "Flexible", "Multi", "Arc", "Lunge", "Yank", "Disarm", "Trip", 4, 1, 4, 6, 3, 0, 4, 0, 2, 0, 4, new String[] {"Hide"}, new String[] {"Dervish"}, new String[] {"Hidzaajji", "Mobyuld"}),
    ...
    new RawWeapon("sai", "A martial-arts weapon with three curving spikes that provide ample ability to disarm foes.", '⍦', "Melee", "Repeat", 1, "PIERCING", "PIERCING", "Dueling", "Dueling", "Multi", "Straight", "Thrust", "Yank", "Disarm", "Impale", 4, 2, 2, 3, 6, 2, 1, 4, 0, 0, 6, new String[] {"Metal"}, new String[] {"Brawler", "Guardian"}, new String[] {"Ninja"}),
    new RawWeapon("trident", "A fishing spear adapted for gladiatorial and maritime combat, the trident has three barbed prongs on a mid-size pole.", '⍦', "Melee", "Repeat", 2, "PIERCING", "PIERCING", "Polearm", "Dueling", "Multi", "Straight", "Brace", "Hurl", "Impale", "Bleed", 3, 6, 2, 1, 4, 4, 4, 0, 1, 0, 4, new String[] {"Metal", "Wood"}, new String[] {"Guardian", "Hunter"}, new String[] {"Cheuritae"}),
    ...
    new RawWeapon("scythe", "A hook-bladed farming tool meant for slicing wide swaths of grain, adapted to slicing wide swaths in necks.", 'ʕ', "Melee", "Repeat", 2, "SLASHING", "SLASHING", "Blade", "Axe", "Sweep", "Straight", "Chop", "Sweep", "Slay", "Sever", 2, 8, 9, 5, 0, 0, 0, 0, 0, 2, 2, new String[] {"Metal", "Wood"}, new String[] {"Hunter", "Brute"}, new String[] {"Chobesh", "Ugexiir"}),
    ...
    new RawWeapon("light crosssbow", "A small machine that launches a bolt with the pull of a trigger; slow to reload, but capable of piercing thick armor.", '⊢', "Ranged", "Projectile", 1, "PIERCING", "PIERCING", "Precise", "Precise", "Beam", "Straight", "Weave", "Bolts", "Impale", "Disable", 6, 5, 2, 1, 0, 1, 0, 1, 5, 1, 2, new String[] {"Wood"}, new String[] {"Marksman"}, new String[] {"Laathrik", "Zedmedov"}),
    new RawWeapon("heavy crossbow", "A weighty machine that can launch a bolt in an instant, but takes a long time to reload; makes up for it with huge power.", '⊢', "Ranged", "Projectile", 2, "PIERCING", "PIERCING", "Precise", "Precise", "Beam", "Straight", "Weave", "Bolts", "Impale", "Slay", 5, 7, 1, 1, 0, 1, 0, 0, 6, 1, 1, new String[] {"Wood"}, new String[] {"Marksman"}, new String[] {"Cheuritae", "Keungeuh"}),
    new RawWeapon("pistol", "This hand-held firearm is very imprecise, but that doesn't always hinder it because its bullet keeps bouncing after missing.", 'ᵣ', "Ranged", "Projectile", 1, "PIERCING", "PIERCING", "Precise", "Precise", "Multi", "Straight", "Ricochet", "Powder", "Slay", "Confound", 3, 8, 7, 1, 0, 0, 0, 3, 4, 0, 0, new String[] {"Metal"}, new String[] {"Marksman", "Duelist"}, new String[] {"Jalgeaux", "Cheuritae"}),
    ...
    new RawWeapon("staff sling", "A curved staff with cords to hold a projectile at one end, this weapon improves a sling's range even further.", 'Ḯ', "Ranged", "Projectile", 2, "BLUNT", "BLUNT", "Forceful", "Forceful", "Multi", "Arc", "Pound", "Pellets", "Confound", "Slay", 2, 4, 2, 5, 0, 2, 1, 1, 5, 0, 3, new String[] {"Wood", "Hide"}, new String[] {"Jester", "Guardian"}, new String[] {"Ikkutiq"}),
    new RawWeapon("chakram", "A bladed hoop with just as much use at medium range as in melee combat, it can be drawn quickly and thrown far.", '°', "Ranged", "Thrown", 1, "SLASHING", "SLASHING", "Blade", "Forceful", "Multi", "Straight", "Chop", "Blur", "Sever", "Disable", 5, 5, 5, 3, 0, 4, 0, 0, 2, 0, 4, new String[] {"Metal"}, new String[] {"Brawler", "Jester"}, new String[] {"Bididhayi"}),
    ...
    new RawWeapon("atlatl", "A simple-looking device that enables a spear to be thrown much further, and with greater precision, than it can by hand.", '⋁', "Ranged", "Projectile", 2, "PIERCING", "PIERCING", "Polearm", "Forceful", "Multi", "Arc", "Heave", "Darts", "Impale", "Slay", 4, 9, 2, 2, 0, 0, 1, 0, 5, 0, 2, new String[] {"Wood"}, new String[] {"Jester", "Hunter"}, new String[] {"Hueztotli"}),
    new RawWeapon("shuriken", "A throwing weapon, shaped like a star or tiny blade, that deals pitiful damage but can be laced with poison.", '★', "Ranged", "Thrown", 1, "PIERCING", "POISON", "Dueling", "Precise", "Multi", "Straight", "Pin", "Blur", "Disable", "Afflict", 3, 1, 1, 6, 1, 0, 0, 6, 2, 1, 6, new String[] {"Metal"}, new String[] {"Assassin"}, new String[] {"Ninja"}),
    new RawWeapon("blowgun", "A simple projectile weapon that allows a quick exhalation to propel a needle at the target; usually the needle is poisoned.", '⁻', "Ranged", "Projectile", 1, "POISON", "PIERCING", "Precise", "Precise", "Multi", "Straight", "Weave", "Needles", "Afflict", "Slay", 4, 1, 2, 6, 0, 0, 5, 6, 2, 0, 2, new String[] {"Wood"}, new String[] {"Assassin", "Hunter"}, new String[] {"Ninja", "Hueztotli"}),
    ...
    new RawWeapon("net", "A heavy mesh with barbed weights on the edge that could be used for fishing or ensnaring fugitives.", '⍯', "Ranged", "Thrown", 2, "BLUNT", "BLUNT", "Flexible", "Forceful", "Sweep", "Arc", "Pound", "Pin", "Trip", "Disable", 4, 0, 0, 6, 6, 3, 4, 0, 2, 1, 1, new String[] {"Cloth"}, new String[] {"Dervish", "Hunter"}, new String[] {"Cheuritae", "Hidzaajji"}),
    new RawWeapon("grenade", "A precursor to other firearms, this is a container of shrapnel and blast powder that causes brutal damage when it works.", '¤', "Ranged", "Projectile", 2, "PIERCING", "SLASHING", "Forceful", "Precise", "Burst", "Arc", "Heave", "Powder", "Slay", "Bleed", 0, 9, 0, 6, 3, 0, 0, 4, 2, 2, 0, new String[] {"Metal"}, new String[] {"Jester"}, new String[] {"Khainghal", "Cheuritae"}),
    new RawWeapon("handcannon", "A simpler model of firearm that has advanced in parallel to the musket, this weapon fires a shell in a very long arc.", 'ɼ', "Ranged", "Projectile", 2, "PIERCING", "SLASHING", "Forceful", "Precise", "Burst", "Arc", "Ricochet", "Powder", "Slay", "Bleed", 0, 9, 0, 5, 0, 0, 0, 0, 6, 2, 0, new String[] {"Metal"}, new String[] {"Guardian"}, new String[] {"Laathrik", "Khainghal"}),
    ...
    new RawWeapon("Ninjutsu style", "The honor-bound empire of Otekai does not teach unarmed combat, but their ninja enemies rely on it heavily.", 'ɱ', "Unarmed", "Repeat", 0, "BLUNT", "BLUNT", "Flowing", "Flowing", "Multi", "Straight", "Blur", "Lunge", "Afflict", "Slay", 4, 1, 5, 5, 3, 0, 0, 6, 0, 0, 6, new String[] {}, new String[] {"Brawler", "Assassin"}, new String[] {"Ninja"}),
    ...
    new RawWeapon("earth magic", "Earth magic is mainly defensive, using barriers of dirt and blocking stones mixed in between blows with rocks.", '⚡', "Magic", "Repeat", 0, "EARTH", "EARTH", "Energy", "Energy", "Wave", "Straight", "Pound", "Seal", "Trip", "Confound", 2, 6, 0, 2, 1, 5, 1, 4, 3, 1, 1, new String[] {}, new String[] {"Sorcerer", "Guardian"}, new String[] {"Otekai", "Krort"}),
    new RawWeapon("water magic", "Water magic utilizes various unpleasant compounds swirled in with otherwise-harmless fluid to cause all sorts of trouble.", '⚡', "Magic", "Repeat", 0, "WATER", "WATER", "Energy", "Energy", "Wave", "Straight", "Blur", "Exorcise", "Trip", "Afflict", 4, 1, 0, 5, 3, 0, 2, 4, 3, 2, 1, new String[] {}, new String[] {"Sorcerer", "Swordsman"}, new String[] {"Elethian", "Cheuritae"}),
    new RawWeapon("air magic", "Air magic uses long-ranged, precise strikes with pieces of debris picked up on the wind.", '⚡', "Magic", "Repeat", 0, "AIR", "AIR", "Energy", "Energy", "Beam", "Arc", "Blur", "Reveal", "Disable", "Confound", 4, 0, 2, 1, 4, 0, 1, 4, 5, 0, 4, new String[] {}, new String[] {"Sorcerer", "Marksman"}, new String[] {"Khainghal", "Ugexiir"}),
    new RawWeapon("crystal magic", "Crystal magic allows creating both beautifully shimmering defensive barriers and deadly slicing shards of gems.", '⚡', "Magic", "Repeat", 0, "CRYSTAL", "CRYSTAL", "Energy", "Energy", "Multi", "Arc", "Shine", "Ricochet", "Blind", "Sever", 3, 5, 5, 2, 0, 4, 3, 0, 3, 1, 0, new String[] {}, new String[] {"Sorcerer", "Swordsman"}, new String[] {"Keungeuh", "Jalgeaux"}),
    new RawWeapon("sound magic", "Sound magic doesn't do much damage, but it can confuse huge swaths of foes at once.", '⚡', "Magic", "Repeat", 0, "SOUND", "SOUND", "Energy", "Energy", "Wave", "Straight", "Sweep", "Blur", "Confound", "Afflict", 2, 1, 0, 6, 1, 0, 1, 5, 3, 3, 2, new String[] {}, new String[] {"Sorcerer", "Jester"}, new String[] {"Mbegonda", "Hyrden"}),
    ...
    new RawWeapon("lightning magic", "Lightning magic strikes suddenly with potent but inaccurate thunderbolts.", '⚡', "Magic", "Repeat", 0, "LIGHTNING", "LIGHTNING", "Energy", "Energy", "Beam", "Straight", "Ricochet", "Yank", "Electrify", "Energize", 0, 5, 0, 2, 2, 0, 0, 4, 4, 2, 5, new String[] {}, new String[] {"Sorcerer", "Brute"}, new String[] {"Bididhayi", "Hidzaajji"}),
    new RawWeapon("poison magic", "Poison magic is usually studied in lawless places, where the cruel death it delivers is already commonplace.", '⚡', "Magic", "Repeat", 0, "POISON", "POISON", "Energy", "Energy", "Burst", "Arc", "Condemn", "Seal", "Afflict", "Slay", 2, 3, 6, 6, 0, 0, 0, 6, 3, 0, 1, new String[] {}, new String[] {"Sorcerer", "Assassin"}, new String[] {"Ninja", "Mobyuld"}),
    ...
    new RawWeapon("caustic magic", "Caustic magic is exceptionally rare, and though it mainly finds industrial uses, some mages can wield it in battle.", '⚡', "Magic", "Repeat", 0, "CAUSTIC", "CAUSTIC", "Energy", "Energy", "Wave", "Straight", "Exorcise", "Reveal", "Afflict", "Blind", 4, 0, 0, 6, 2, 1, 0, 4, 4, 1, 3, new String[] {}, new String[] {"Sorcerer", "Wizard"}, new String[] {"Keungeuh", "Ugexiir"}),
    ...
    new RawWeapon("life magic", "Life magic can be used offensively by moving vitality around in opponents, potentially weakening or even killing them.", '⚡', "Magic", "Repeat", 0, "LIFE", "LIFE", "Energy", "Energy", "Multi", "Straight", "Exorcise", "Weave", "Regenerate", "Bleed", 5, 1, 3, 6, 0, 0, 3, 4, 4, 0, 0, new String[] {}, new String[] {"Sorcerer", "Priest"}, new String[] {"Elethian", "Bididhayi"}),
    ...
    new RawWeapon("temporal magic", "Temporal magic manipulates time in minor ways to cause significant headaches for enemies.", '⚡', "Magic", "Repeat", 0, "TEMPORAL", "TEMPORAL", "Energy", "Energy", "Through", "Straight", "Blur", "Pin", "Confound", "Trip", 2, 0, 0, 6, 4, 0, 0, 4, 3, 1, 6, new String[] {}, new String[] {"Sorcerer", "Seer"}, new String[] {"Cheuritae", "Ikkutiq"}),
    ...
    new RawWeapon("contractual magic", "Contractual magic uses the power of laws, both laws written by people and laws that define the cosmos, to disable foes.", '⚡', "Magic", "Repeat", 0, "CONTRACTUAL", "CONTRACTUAL", "Energy", "Energy", "Through", "Straight", "Reveal", "Seal", "Disable", "Confound", 6, 0, 0, 6, 0, 4, 2, 0, 3, 1, 4, new String[] {}, new String[] {"Sorcerer", "Wizard"}, new String[] {"Otekai", "Keungeuh"}),
    ...
    new RawWeapon("vacuous magic", "Vacuous magic deals with a peculiar subject: regions that contain no other elements, such as the void of space.", '⚡', "Magic", "Repeat", 0, "VACUOUS", "VACUOUS", "Energy", "Energy", "Burst", "Arc", "Yank", "Reveal", "Silence", "Disarm", 1, 4, 0, 4, 2, 0, 0, 4, 3, 3, 3, new String[] {}, new String[] {"Sorcerer", "Assassin"}, new String[] {"Chobesh", "Cheuritae"}),
    new RawWeapon("warp magic", "Warp magic is a skill in high demand from criminals and police alike, since it can move objects or people instantly.", '⚡', "Magic", "Repeat", 0, "WARP", "WARP", "Energy", "Energy", "Through", "Straight", "Yank", "Seal", "Disarm", "Confound", 2, 1, 0, 3, 6, 0, 0, 4, 5, 2, 0, new String[] {}, new String[] {"Sorcerer", "Dervish"}, new String[] {"Ninja", "Ikkutiq"}),
    new RawWeapon("radiation magic", "Radiation magic isn't well-understood by common folk, and its users are generally feared for the illnesses that follow them.", '⚡', "Magic", "Repeat", 0, "RADIATION", "RADIATION", "Energy", "Energy", "Beam", "Straight", "Shine", "Exorcise", "Irradiate", "Afflict", 4, 6, 0, 5, 0, 0, 0, 4, 4, 1, 1, new String[] {}, new String[] {"Sorcerer", "Marksman"}, new String[] {"Zedmedov", "Khainghal"}),
  };

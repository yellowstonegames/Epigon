...
public class RawCulture implements Serializable {
  ...
  public static final RawCulture[] ENTRIES = new RawCulture[] {
    ...
    new RawCulture("Hueztotli", "A nation that has somehow survived despite being based in a jungle with terrifyingly-strong monsters.", "North Inner-Cap"),
    new RawCulture("Hyrden", "An alliance of a church and a kingdom; they routinely crusade against undead in the West Bowl.", "West Outer-Cap"),
    ...
    new RawCulture("Mbegonda", "A group of nations across a wide area that speak a common language, but don't share a government.", "South Inner-Cap"),
    ...
    new RawCulture("Ninja", "A rebel state that has split off of Otekai, and has been embroiled in that civil war for centuries.", "East Outer-Cap"),
    new RawCulture("Otekai", "An honor-driven nation that refuses to admit surrender or sign a treaty in their war against the Ninja.", "East Outer-Cap"),
    ...
    new RawCulture("Zedmedov", "A grim nation that has the misfortune of being located closest to the undead-infested West Bowl.", "West Rim"),
    new RawCulture("Nuruk", "A fallen empire of necromancers overthrown by their undead minions; the walking dead own this land.", "West Bowl"),
  };

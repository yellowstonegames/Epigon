...
import static squidpony.squidmath.LightRNG.*; // comment this out if using custom determine()
...
//     * <br>
//     * EDIT: HotSpot seems to intermittently forgot how to optimize rotations, and even changing determine(state++) to
//     * determine(++state) can cause correctly optimized code to unexpectedly slow down. Using LightRNG for now; working
//     * on improvements that are faster.

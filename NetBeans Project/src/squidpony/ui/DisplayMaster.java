...
import squidpony.actions.AOE;
import squidpony.data.ConditionChangeType;
import squidpony.data.InventoryChangeType;
import squidpony.data.Stat;
import squidpony.data.generic.Energy;
...
import squidpony.dm.Planner;
import squidpony.mapping.EpiMap;
import squidpony.mapping.EpiTile;
import squidpony.squidgrid.libgdx.SGPanelGDX;
import squidpony.universe.Achievement;
    ...
    public void setView(EpiMap map, int startx, int starty) {
        ...
        for (int x = 0; x < w; x++) {
            for (int y = 0; y < h; y++) {
                ...
                viewPanel.placeCharacter(x, y, tile.getSymbol(), tile.getForegroundColor());
            }
        }
